...
class WaveView extends StatefulWidget {
  ...
  const WaveView(
      {Key key, this.percentageValue: 100.0, this.colorCode: "#D1F2A5"})
      : super(key: key);
  @override
        ...
        builder: (context, child) => new Stack(
          children: <Widget>[
            new ClipPath(
              child: new Container(
                decoration: BoxDecoration(
                  color: PrimaryTheme.nearlyDarkBlue.withOpacity(0.5),
                  ...
                  gradient: LinearGradient(
                    colors: [
                      HexColor(widget.colorCode).withOpacity(0.2),
                      HexColor(widget.colorCode).withOpacity(0.5)
                    ],
            ...
            new ClipPath(
              child: new Container(
                decoration: BoxDecoration(
                  color: HexColor(widget.colorCode),
                  gradient: LinearGradient(
                    colors: [
                      HexColor(widget.colorCode).withOpacity(0.4),
                      HexColor(widget.colorCode)
                    ],
                    begin: Alignment.topLeft,
                    end: Alignment.bottomRight,
                  ),
            ...
            Positioned(
              ...
              child: new ScaleTransition(
                ...
                child: Container(
                  ...
                  height: 2,
                  decoration: BoxDecoration(
                    color: PrimaryTheme.white.withOpacity(0.4),
            ...
            Positioned(
              ...
              child: new Transform(
                ...
                child: Container(
                  ...
                  height: 4,
                  decoration: BoxDecoration(
                    color: PrimaryTheme.white.withOpacity(
